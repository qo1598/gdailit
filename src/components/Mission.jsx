...
const MISSIONS = {
    ...
    'M-3': {
        ...
        competency: 'AI 사용 판단 및 윤리',
        why: 'AI는 램프의 지니 같지만 상상력이 부족해요. "그냥 좀 멋지게 해줘"라고 하면 대충 만들지만, "초록 망토를 입고 별빛 아래에서 기타 치는 고양이를 사실적으로 밝고 쨍하게 그려줘"라고 구체적으로 말해야 명작이 탄생합니다.',
        example: '천재를 부르는 특별 주문(프롬프트): 구체적 주제 + 배경 조건 + 원하는 분위기',
        prompts: {
            lower: ['내 머릿속에 쏙 있는 상상 속의 우주선을 아주아주 자세하게 묘사해 봐요! 날개 모양, 색깔, 무늬 등을 마치 눈앞에 있는 것처럼 생생하게 적어보아요.'],
            middle: ['램프의 지니에게 "멋진 비행기 하나 줘봐"라고 성의 없이 말하면 이상한 종이비행기를 던지고 갑니다. AI가 내 마음을 알아차리도록 색깔, 배경, 느낌 등 아주 특별한 조건을 듬뿍 담은 완벽 주문서를 작성해 봅시다.'],
            upper: ['원하는 리서치 결과를 단 한 번만에 완벽하게 얻기 위해, 나만의 강력한 "주문 공식(프롬프트 구조)"을 설계해 보세요. [역할+과제+제약+형식] 공식을 만들고 실제로 시연해 볼까요?']
        },
        type: 'direct-text',
        stackedInputs: {
            lower: [{ id: 'describe', type: 'textarea', label: '1. 내 머릿속의 우주선 묘사 도화지', placeholder: '우주선의 모양, 색깔, 장식 등 AI가 똑같은 그림을 그릴 수 있게 자세한 단어들을 마구마구 떠올리세요.' }, { id: 'guess', type: 'text', label: '2. 자세히 말해줄수록 AI가 똑같이 그릴까요?', placeholder: '내 설명을 들으면 AI가 내 마음과 똑같은 그림을 그려줄 수 있을까요?' }],
            middle: [{ id: 'bad_prompt', type: 'text', label: '1. AI를 헷갈리게 하는 엉망진창 멍청 주문!', placeholder: '힌트 없이 아주 성의없고 짧게 "해 줘"라고 한 문장을 만들어 보세요.' }, { id: 'good_prompt', type: 'textarea', label: '2. 100점 만점 완벽한 주문 노트!', placeholder: '배경+색상+스타일+조명 등 3가지 이상의 조건을 넣어 꼼꼼한 문장으로 지시해 보세요.' }],
            upper: [{ id: 'structure', type: 'textarea', label: '1. 나만의 프롬프트 조립 공식 뼈대', placeholder: '[역할 부여] -> [해결 과제] -> [제약 사항] -> [출력 형식]과 같은 나만의 논리 뼈대를 세우세요.' }, { id: 'example_prompt', type: 'textarea', label: '2. 설계 공식을 완벽 적용한 고도화 주문 생성 예제', placeholder: '위에서 만든 뼈대에 기후변화나 과학 탐구 같은 주제를 대입하여 완성된 문장을 만드세요.' }]
        }
    },
    'M-4': {
