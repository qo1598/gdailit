    ...
    middle: {
      ...
      submit: {
        ...
        artifact: {
          ...
          template: "{step2}는 {step3}를 해주는 AI예요. {step4} {step5}"
        }
      }
    },
    ...
    upper: {
      ...
      submit: {
        ...
        artifact: {
          ...
          template: "우리는 AI를 {step4}할 때 AI라고 본다."
        }
      }
    }
  }
