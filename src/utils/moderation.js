...
const BAD_WORDS = [
  ...
  "죽어", "꺼져", "시발", "병신", "애미", "창녀", "씨벌", "엿먹어", "뒤져", "닥쳐",
  "엠창", "느금마", "니미", "시펄", "ㅅㅂ", "ㅂㅅ", "ㅈㄴ", "ㅆㅂ", "좆", "좃",
  "개나발", "개좆", "미친놈", "미친년", "색기", "병진", "호로", "씨부랄", "씨부레",
  "망할", "썅", "개같은", "상놈", "쌍놈", "따까리", "빠가", "짱개", "쪽바리", "깜둥이",
  "뚱땡이", "돼지새끼", "꼴통", "허접", "빙신", "호구", "찐따", "찐찌버거", "관종"
];
