/**
 * LearnAILIT V3 · E-2 AI 답, 믿어도 될까?
 * 시나리오 기반 수행 평가 — 공통 인터페이스 적용본
 */

export const E2_V3_SCENARIO = {
  meta: {
    code: "E-2",
    title: "AI 답, 믿어도 될까?",
    domain: "Engaging",
    ...
    lower: {
      ...
      steps: [
        {
          ...
          feedback: {
            onCorrect: null,
            onWrong: null,
            onMiss: "이 답은 사실과 달라요! 게시판에 붙이면 친구들이 틀린 정보를 볼 수 있어요."
          },
        ...
        },
        {
          ...
          feedback: {
            onCorrect: null,
            onWrong: "AI의 말을 그대로 쓰면 이상한 답이 게시판에 올라갈 수 있어요!",
            onMiss: null
          },
        ...
        },
        {
          ...
          question: "어떤 카드를 게시판에 붙일 수 있을까요? 맞는 답 카드는 붙여도 되고, 이상한 답 카드는 확인 후 붙여요.",
          hint: "STEP 1에서 판단한 결과를 바탕으로 결정해요.",
          uiMode: "per_case_judge",
          // step1에서 strange로 판정한 카드만 이 step에 등장
          branch: { sourceStepId: "step1", filterBy: "strange", mode: "filter" },
          judgmentOptions: [
            { id: "post",  label: "게시판에 붙여요", emoji: "✅" },
            { id: "hold",  label: "확인 후 붙여요",  emoji: "🔄" }
          ],
          validation: { required: true }
        }
      ],
      ...
      submit: {
        ...
        artifact: {
          ...
          template: "이상한 답 {step1_strange_count}개를 찾았고, {step3} 결정을 내렸어요."
        }
      }
    },
      ...
      steps: [
        ...
        },
        {
          ...
          feedback: {
            onCorrect: null,
            onWrong: null,
            onMiss: "이 말풍선을 그냥 넘겼어요! 카드뉴스에 넣으면 틀린 정보가 퍼질 수 있어요."
          },
          validation: { required: true }
        },
        {
          ...
          question: "의심스러운 말풍선에 대해 AI에게 다시 확인할 질문을 만들어보세요.",
          hint: "\"정말 그런가요?\", \"어디에서 확인할 수 있나요?\", \"근거가 있나요?\" 같은 확인 질문을 써보세요.",
          uiMode: "free_text",
          // step2에서 strange로 고른 말풍선을 참고해 확인 질문 작성
          // 예: "정말 그런가요? 근거가 있나요?", "어디에서 확인할 수 있나요?"
          branch: { sourceStepId: "step2", filterBy: "strange", mode: "filter" },
